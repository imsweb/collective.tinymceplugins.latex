...
#
#  $ bin/test -s ims.jamis -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ims.jamis.testing.IMS_JAMIS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ims/jamis/tests/robot/test_example.robot
#
